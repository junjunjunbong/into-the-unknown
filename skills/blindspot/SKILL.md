...
- What counts as settled (for this skill): an entry settles only when the user passes its teach-back question or restates the point in their own words (Step 4). Settled means the *user* said or confirmed it — writing it into a report does not count.
